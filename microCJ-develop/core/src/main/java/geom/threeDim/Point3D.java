...
public class Point3D implements Point {
	 ...
	 * @since JavaFX 8.0
	 */
	private Point3D midpoint(double x, double y, double z) {
		return new Point3D(
				x + (getX() - x) / 2.0,
				y + (getY() - y) / 2.0,
				z + (getZ() - z) / 2.0);
	 ...
	 * @since JavaFX 8.0
	 */
	private double angle(double x, double y, double z) {
	 ...
	 * @since JavaFX 8.0
	 */
	private double dotProduct(double x, double y, double z) {
	 ...
	 * @since JavaFX 8.0
	 */
	private Point3D crossProduct(double x, double y, double z) {
		final double ax = getX();
		final double ay = getY();
		final double az = getZ();
	...
	public String toUserString() {
		return "[x = " + String.format("%.2f", getX())
				+ ", y = " + String.format("%.2f", getY())
				+ ", z = " + String.format("%.2f", getZ()) + "]";
	}
}
